...
screening1.save()
screening2 = Screening.new({"film_id" => film2.id, "screen_time" => "12:00", "screen_limit" => 10})
screening2.save()
screening3 = Screening.new({"film_id" => film3.id, "screen_time" => "15:00", "screen_limit" => 15})
screening3.save()
